...
def json_to_new_dict():
    a = json.load(open('support_data/data_harvest1.json'))
    ...
    qualifierdict={3: 'author',15: 'issued',20: 'isbn',21: 'issn',25: 'uri',72: 'url',
        ...
        119: 'recensionseries',124: 'pid',137: 'doi', 39:'publisher'}
    ...
    for item in range(0,len(a["result"])):
        ...
        if "metadata" in records.keys():
            ...
            for item_values in values:
                ...
                if not '@qualifier' in item_values.keys() and '@element' in item_values.keys():
                    if 'publisher'==item_values['@element']:
                            temp[39]=item_values['#text']
